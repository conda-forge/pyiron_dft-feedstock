About pyiron_dft-feedstock
==========================

Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/pyiron_dft-feedstock/blob/main/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=5439&branchName=main">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/pyiron_dft-feedstock?branchName=main">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `pyiron_dft` can be installed with `conda`:
...
```
mamba install pyiron_dft
```

It is possible to list all of the versions of `pyiron_dft` available on your platform with `conda`:
...
```
mamba search pyiron_dft --channel conda-forge
```
...
mamba repoquery search pyiron_dft --channel conda-forge

# List packages depending on `pyiron_dft`:
mamba repoquery whoneeds pyiron_dft --channel conda-forge

# List dependencies of `pyiron_dft`:
mamba repoquery depends pyiron_dft --channel conda-forge
```
...
* [@sudarsan1989](https://github.com/sudarsan1989/)
